    ...
    <article v-for="article in articles" :key="article.id">
      ...
      <div class="article-content" v-else>
        ...
        <div class="article-title">
          ...
          <h2><input type="text" v-model="editingArticle.name"> - <input type="number" v-model="editingArticle.price"></h2><div>
...
module.exports = {
  ...
  components : {
    'add-article' : httpVueLoader('components/AddArticle.vue')
  },
